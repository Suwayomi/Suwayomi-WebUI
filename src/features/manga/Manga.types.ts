...
import type { MigrationSearchResult } from '@/features/migration/Migration.types.ts';
...
export interface MangaCardProps {
    ...
    onMigrateSelect?: (manga: Omit<MigrationSearchResult, 'sourceTitle' | 'isManualMatch'>) => void;
    mode?: MangaCardMode;
}
