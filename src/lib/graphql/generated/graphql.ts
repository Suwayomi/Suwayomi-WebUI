...
export type GetAboutQuery = { __typename: 'Query', aboutServer: { __typename: 'AboutServerPayload', buildTime: string, buildType: string, discord: string, github: string, name: string, version: string }, aboutWebUI: { __typename: 'AboutWebUI', channel: Types.WebUiChannel, tag: string, updateTimestamp: string } };
