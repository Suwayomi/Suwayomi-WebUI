...
export type TrackerSearchQuery = { __typename?: 'Query', searchTracker: { __typename?: 'SearchTrackerPayload', trackSearches: Array<{ __typename?: 'TrackSearchType', id: number, title: string, coverUrl: string, publishingStatus: string, publishingType: string, remoteId: any, startDate: string, summary: string, totalChapters: number, trackerId: number, trackingUrl: string }> } };
