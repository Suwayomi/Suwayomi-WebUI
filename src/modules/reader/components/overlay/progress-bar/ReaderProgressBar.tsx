...
export const ReaderProgressBar = ({
    ...
    createProgressBarSlot: (page: ReaderProgressBarProps['pages'][number], index: number) => ReactNode;
    slotProps?: {
        container?: BoxProps;
    ...
    return (
        <ReaderProgressBarContainer {...slotProps?.container}>
            <ReaderProgressBarRoot {...slotProps?.progressBarRoot}>
                    ...
                    >
                        <ReaderProgressBarSlotsContainer {...slotProps?.progressBarSlotsContainer}>
                            {pages.map((page, pagesIndex) => (
                                ...
                                >
                                    {createProgressBarSlot(page, pagesIndex)}
                                </Box>
                            ))}
                            <ProgressBarHighlightReadPages
                                {...slotProps?.progressBarReadPages}
                                currentPagesIndex={currentPage[2]}
                ...
                <ReaderProgressBarPageNumber
                    ...
                    sx={{
                        // @ts-ignore - for some reason spreading more than 1 object breaks the typing of minWidth
                        minWidth: '0px',
