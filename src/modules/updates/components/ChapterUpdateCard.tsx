...
import { ChapterRecentListFieldsFragment, DownloadState } from '@/lib/graphql/generated/graphql.ts';
...
export const ChapterUpdateCard = memo(({ chapter }: { chapter: ChapterRecentListFieldsFragment }) => {
    const { manga } = chapter;
