...
export const History: React.FC = () => {
    ...
    const updateEntries = chapterHistoryData?.chapters.nodes ?? [];
    const groupedHistory = useMemo(() => groupByDate(updateEntries), [updateEntries]);
            ...
            <StyledGroupedVirtuoso
                ...
                itemContent={(index) => (
                    <StyledGroupItemWrapper>
                        <ChapterHistoryCard chapter={updateEntries[index]} />
                    </StyledGroupItemWrapper>
                )}
            />
        </>
